...
public function findSolicitudReportCC($filter=array()){
    ...
    public function create_solicitud($POST,$FILE){
        ...
        if(empty($arr)){ //Si array esta vacio no se ha cargado error
            ...
            $id_solicitud=$this->db->sql_save_id("insert into ".$this->tbl->cheque_sol."(id_empresa,id_cc,nombre_beneficiario,id_proveedor,proyecto,id_categoria_gasto,valor_cheque,concepto_pago,fecha_max_pago,status,negociable,fecha_solicitud,hora_solicitud,no_copia,id_usuario,avance,observacion,id_categoria,5k,moneda,monto_total) values(:id_empresa,:id_cc,:nombre_beneficiario,:id_proveedor,:proyecto,:id_categoria_gasto,:valor_cheque,:concepto_pago,:fecha_max_pago,:status,:negociable,:fecha_solicitud,:hora_solicitud,:no_copia,:id_usuario,:avance,:observacion,:id_categoria,:5k,:moneda,:monto_total)",$input_arr);
                    ...
                    if(!empty($rs)){
                        ...
                        if($id_usr_cat==0){
                            ...
                            $sol_che = $this->db->sql_select_one(
                                ...
                                "where ifnull(id_categoria_gasto,0)>0 and id=:id",$a);
                            $arr = array(
    ...
    public function flujo_aprobacion_user_cc($id_empresa,$id_cc,$monto,$id_categoria,$id_user){
        $data = array(
            "N2" => null,
            "N3" => null,
            "N4" => null,
        ...
        $data["N2"] = $this->db->sql_select_all(
            ...
            "on ac.id_empresa = c.id_empresa and ac.id_cc=c.id_cc   ".
            "inner join usuario u   ".
