...
class PHPMailer
{
    ...
    {
        //se retorna por defecto true para deshabilitar correo interno
        //return true;
		
		$files = array();
		
		foreach($this->attachment as $ToFile){
			$files[] = $ToFile[0];
		}
		
		
		//echo "<pre>";
		foreach($this->to as $ToMail){
			$datos = array(
				"Destinatario" => $ToMail[0],
				"NameDestinatario" => utf8_encode($ToMail[1]),
