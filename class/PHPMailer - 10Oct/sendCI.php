...
if(is_array($_REQUEST)) {
	...
	$sql = "Select * From ci_enc Where id_ci = ".$id;
	...
	$mail->setFrom('ci@impressa.com', 'Consumo Interno');
	$mail->isHTML(true);                                  // Set email format to HTML
	//$mail->addAddress("wserpas@impressa.com", "Desarrollo");
	...
	$body = 'Se ha enviado la solicitud de consumo interno #'.$row['ci_numero']. " para su gestion.";
	
	$mail->Subject = 'Solicitud de consumo para gestion #'.$row['ci_numero'];
	...
	header('Location: http://192.168.40.6/sics/?c=ci&a=inicio&id=12');
	die();
