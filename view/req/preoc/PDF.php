...
$_SqlI = "Select d.prod_codigo, sum(d.predreq_cantidad_aut) as tunidades, d.predreq_unidad, d.predreq_descripcion, d.predreq_prec_uni, sum(d.predreq_total) as tvalor, d.predreq_usuario_col From ".$conf->getTbl_predreq()." d"
...
if ($contar[0] <= 15){
	while ($rowI = mysqli_fetch_array($_QryI)) {
		$usuario_colecta = $rowI['predreq_usuario_col'];
		$itemD .= '<tr>
...
$pies .= '<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td align="center">___'.$usuario_colecta.'___</td>
