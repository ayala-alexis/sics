...
<h4 class="title">
	<i class="glyphicon glyphicon-user"></i> Consulta de Solicitud(es) Pendiente(s) por Cco. de <b><?php echo $perfil->usuario_nombre?></b>.
</h4>
...
<table class="table tbl-kpi">
	<thead>
		<tr>
			...
			<th style="min-width: 250px">Descrición</th>
